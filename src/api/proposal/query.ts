...
export const PROPOSAL_QUERY_KEYS = {
  ...
  attachments: (autoid: string) => [...PROPOSAL_QUERY_KEYS.all(), 'attachments', autoid] as const
}
...
export const getProposalAttachmentsQuery = (autoid: string, projectId?: number | null) =>
  queryOptions({
