...
export const FILTER_PRESET_QUERY_KEYS = {
  ...
  list: (params?: FilterPresetParams) => [...FILTER_PRESET_QUERY_KEYS.lists(), params] as const,
  byEntity: (entityType: FilterPresetEntityType, projectId?: number) =>
    [
      ...FILTER_PRESET_QUERY_KEYS.lists(),
      { entity_type: entityType, project_id: projectId }
    ] as const
}
...
export const getFilterPresetsByEntityQuery = (
