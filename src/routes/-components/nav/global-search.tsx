          ...
          >
            ...
            >
                    ...
                    {orders.map((o, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {isActive && (
                            <ArrowRight className='text-text-quaternary size-3 shrink-0' />
                          )}
                        </button>
                      )
                    })}
              ...
              <div className='flex items-center gap-3 border-t border-border px-4 py-2'>
                {hasResults && (
                  <>
                    <div className='text-text-quaternary flex items-center gap-1.5 text-[11px]'>
                      <kbd className='inline-flex size-4 items-center justify-center rounded-[3px] border border-border bg-bg-secondary text-[10px]'>
                        ↑
                      </kbd>
                      <kbd className='inline-flex size-4 items-center justify-center rounded-[3px] border border-border bg-bg-secondary text-[10px]'>
                        ↓
                    ...
                    <div className='text-text-quaternary flex items-center gap-1.5 text-[11px]'>
                      <kbd className='inline-flex h-4 items-center justify-center rounded-[3px] border border-border bg-bg-secondary px-1 text-[10px]'>
                        ↵
                      </kbd>
                      <span>Open</span>
                    </div>
