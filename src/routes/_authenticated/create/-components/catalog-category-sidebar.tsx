        ...
        {loading ? (
          ...
          <div className='flex flex-col items-center gap-1.5 px-4 py-14 text-center'>
            ...
            {path.length > 0 && (
              <button
                type='button'
                className='mt-1 inline-flex h-7 items-center gap-1 rounded-[5px] border border-border bg-bg-secondary px-2.5 text-[12px] font-medium text-text-secondary transition-colors duration-80 hover:bg-bg-active hover:text-foreground'
                onClick={handleGoBack}
              >
