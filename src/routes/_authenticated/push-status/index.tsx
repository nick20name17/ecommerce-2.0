  ...
  return (
    ...
    >
      <div className='flex min-w-0 flex-1 items-center gap-1.5'>
        ...
        <span className='truncate text-[13px] font-medium text-foreground'>{row.project_name}</span>
      </div>
      ...
      <div className='w-40 shrink-0 truncate text-[12px] text-text-tertiary tabular-nums'>
