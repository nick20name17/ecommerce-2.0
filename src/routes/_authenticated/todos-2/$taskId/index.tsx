...
import { TaskAttachments } from '@/routes/_authenticated/tasks/-components/task-attachments'
...
export const Route = createFileRoute('/_authenticated/todos-2/$taskId/')({
...
function TaskDetailPage() {
  ...
  const updateMutation = useMutation({
    ...
    onMutate: async (payload) => {
      ...
      queryClient.setQueryData(
        ...
        (old: Task | undefined) => (old ? { ...old, ...payload } : old)
      )
      return { previous }
    },
  ...
  if (Number.isNaN(id)) {
    return (
      <div className='-m-4 flex h-[calc(100%+2rem)] items-center justify-center'>
  ...
  if (isLoading) {
    return (
      <div className='-m-4 flex h-[calc(100%+2rem)] flex-col overflow-hidden'>
        <header className={cn('flex shrink-0 items-center justify-between border-b border-border py-2', isMobile ? 'px-5' : 'px-8')}>
          <Skeleton className='h-4 w-24' />
          <Skeleton className='h-4 w-16' />
        </header>
        <div className='flex min-h-0 flex-1'>
          <div className={cn('flex-1 overflow-y-auto', isMobile ? 'px-5 pt-5' : 'px-8 pt-6')}>
          ...
          {!isMobile && (
            <div className='w-[240px] shrink-0 border-l border-border p-5'>
      ...
      <div className={cn('flex min-h-0 flex-1', isMobile && 'flex-col')}>
        ...
        <div className={cn('flex-1 overflow-y-auto', isMobile ? 'px-5 pt-5' : 'px-8 pt-6')}>
          <div className='mx-auto max-w-[640px] pb-16'>
            ...
            {/* Attachments */}
            <div className='mb-8'>
              <TaskAttachments taskId={task.id} attachments={task.attachments ?? []} showDropZone={false} />
            </div>
              ...
              <div className='flex items-start gap-2.5'>
                ...
                <div className='min-w-0 flex-1'>
                  ...
                  <div className='mt-1.5 flex justify-end'>
                    <button
                      type='button'
                      className='rounded-[6px] bg-primary px-3 py-1 text-[12px] font-medium text-primary-foreground transition-colors duration-[80ms] hover:opacity-90'
                    >
                      Send
                    </button>
                  </div>
        ...
        <div className={cn(
          ...
          isMobile
            ...
            : 'w-[240px] border-l border-border'
        )}>
          <div className={cn(isMobile ? '' : 'p-5')}>
            <div className='mb-4 text-[11px] font-semibold uppercase tracking-[0.06em] text-text-tertiary'>
              Properties
            </div>
