                      ...
                      <Popover>
                        <PopoverTrigger asChild>
                          ...
                          >
                            ...
                            <ChevronDown className='text-text-quaternary size-4 shrink-0' />
                          </button>
                        </PopoverTrigger>
                        <PopoverContent
                          align='start'
                ...
                <div>
                  ...
                  >
                    <div className='min-w-0 flex-1'>
                      ...
                      <p className='text-[12px] text-text-tertiary'>
                        {[shipTo.address1, shipTo.city, shipTo.state, shipTo.postal]
                          .filter(Boolean)
                          .join(', ')}
                      </p>
                    </div>
                    <Pencil className='text-text-quaternary size-3.5 shrink-0' />
                  </button>
                </div>
              ...
              <>
                {selectedAddress && (
                  <div className='rounded-lg bg-bg-secondary/50 px-3 py-2 text-[12px] text-text-tertiary'>
                    ...
                    Package {length}×{width}×{height} {dimLabel}
                    ...
                    return (
                      ...
                      >
                        ...
                        <Button
                          ...
                          isPending={
                            selectMutation.isPending && selectMutation.variables === rateId
                          }
