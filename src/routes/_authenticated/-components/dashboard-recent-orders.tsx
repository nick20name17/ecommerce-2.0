              ...
              <tr key={order.autoid}>
                ...
                <td className='px-3 py-2.5 sm:px-4'>
                  <Link
                    ...
                    className='text-text-primary text-[13px] font-medium whitespace-nowrap hover:underline'
                  >
                ...
                <td className='px-3 py-2.5 text-right text-[13px] whitespace-nowrap text-text-tertiary tabular-nums sm:px-4'>
          ...
          >
            ...
            <div className='min-w-0 flex-1'>
              ...
              <div className='flex items-center gap-2 text-[12px] text-text-tertiary'>
                {order.name && <span className='truncate'>{order.name}</span>}
