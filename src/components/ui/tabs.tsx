  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'group-data-[variant=outline]/tabs-list:border-input group-data-[variant=outline]/tabs-list:data-active:bg-foreground group-data-[variant=outline]/tabs-list:data-active:text-background group-data-[variant=outline]/tabs-list:data-active:border-foreground group-data-[variant=outline]/tabs-list:h-auto group-data-[variant=outline]/tabs-list:bg-transparent group-data-[variant=outline]/tabs-list:px-3 group-data-[variant=outline]/tabs-list:py-1.5',
